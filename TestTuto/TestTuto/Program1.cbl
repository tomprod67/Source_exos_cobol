      ...
      ***** SPECIAL-NAMES (Différents reglages sur le programme : choix alphabet, point décimal = comma (,) , currency sign) *****
         special-names.
      ...
      **********************************************************************************************
      ***** INPUT-OUTPUT SECTION (Décrire fichiers, file-control, I-O-Control, gestion mémoire ***** 
      ...
      ***** FILE SECTION (traitement fichier et variable liés au(x) fichier(s)) *****
        file section.
      ...
      *INCLURE BDD*
           ...
           EXEC SQL
             INCLUDE SQLDA
           END-EXEC.
      ***** SCREEN SECTION (Utilisé pour décrire ce que l'on vois à l'ecran, on indique la ligne et la colonne - UNIQUEMENT SUR VISUAL STUDIO) *****
             screen section.
